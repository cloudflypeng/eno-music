  ...
  <section class="h-screen overflow-auto">
    ...
    <div class="flex gap-10 px-20 flex-wrap">
      <div
        ...
        :key="singerMid"
        class="flex flex-col flex-shrink-0 justify-center items-center"
    ...
    <div class="flex gap-10 px-20 flex-wrap mb-30">
      ...
      <div
        border="1 gray-200"
        class="flex flex-col flex-shrink-0 justify-center items-center cursor-pointer
      ...
      >
        ...
        <Dialog :open="dialogVis" title="添加自定义歌手" @visible-change="dialogVis = $event">
          <div class="flex flex-col gap-3 w-full h-full justify-between">
            ...
            >
            <button
              class="w-full h-10 bg-$eno-fill-2 text-white rounded-4"
              @click="addSinger"
            >
              添加
            </button>
